...
<html>
<head>
<title>Offine Product Booking page</title>
<meta charset="utf-8">
...
<div class="container-fluid" id ="banner"> <br><br><br><br><br><br><br>
  <div class="col-md-6 search"><br>
    <h2 style="text-align: center;">Offine Product Booking </h2><br>
    <?php $un=$this->session->userdata('userid');?>
    <?=form_open('admin/offline_order/confirmbook'); ?>
    ...
    <table class="table">
       ...
       <tr>
        ...
        <td><?=form_input(['name'=>'customer_name','placeholder'=>'Enter Name:','class'=>'form-control']);?></td>
      ...
      <tr>
        ...
        <td><?=form_input(['name'=>'pincode','placeholder'=>'Enter Pin Code:','class'=>'form-control']);?></td>
     </tr>
      ...
      <tr>
        ...
        <td><?=form_input(['name'=>'email','placeholder'=>'Enter Email:','class'=>'form-control']);?></td>
      </tr>
