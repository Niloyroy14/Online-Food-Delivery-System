...
<html>
<head>
<title>online Oredr display page</title>
<meta charset="utf-8">
...
<div class="container-fluid" id ="banner"> <br><br><br><br><br><br><br>
  <div class="col-md-8 search"><br>
    <h2 style="text-align: center;">Online Oredr Display</h2><br>
   ...
   ?>
     ...
     <table class="table">
     	<tr>
          ...
          <th><font color="blue"><center>User Name</center></font></th>
     	...
     	<tr>
     		...
     		<td><center><?=$data->user_name;?></center></td>
     		<td><center><?=$data->address;?></center></td>
     		<td><center><?=$data->city;?></center></td>
     		<td><center><?=$data->mobile_no;?></center></td>	
        <td>
         <center><b><a href="<?=base_url()?>admin/online_order/edit/<?php echo $data->id;?>" class="btn btn-warning">Edit</a></b></center>
        </td>

        <td> 
          <center><b><a href="<?=base_url()?>admin/online_order/delete/<?php echo $data->id;?>" class="btn btn-danger">Delete</a></b></center>
        </td>
     	</tr>
